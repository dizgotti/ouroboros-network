...
cmtPeerAddr (TrIncludeConnectionInState _ peerAddr _) = Just peerAddr
...
cmtPeerAddr (TrConnectionWaitTime connId)       = Just (remoteAddress connId)
cmtPeerAddr (TrConnectionTerminated connId _ _) = Just (remoteAddress connId)
